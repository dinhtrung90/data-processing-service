...
@RestController
@RequestMapping("/api/data-processing-kafka")
public class DataProcessingKafkaResource {
    private final Logger log = LoggerFactory.getLogger(DataProcessingKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DataProcessingKafkaResource(KafkaProperties kafkaProperties) {

...
class EligibilityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Eligibility entity")
        ...
        .repeat(2) {
            ...
            .get("/services/dataprocessing/api/eligibilities")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new eligibility")
            .post("/services/dataprocessing/api/eligibilities")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/dataprocessing${new_eligibility_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created eligibility")
            .delete("/services/dataprocessing${new_eligibility_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
